...
interface AllMaterialListProps {
    ordersList: Array<object>;
}

const CoopAllMaterialListSection: FC<AllMaterialListProps> = ({ ordersList }: AllMaterialListProps) => {
...
export default CoopAllMaterialListSection;
