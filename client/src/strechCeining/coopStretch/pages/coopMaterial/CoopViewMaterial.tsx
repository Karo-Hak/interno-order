...
import CoopAllMaterialListSection from "./CoopAllMaterialListSection";
import CoopMaterialListSection from "./CoopMaterialListSection";
import { CoopMaterialSearchLogic } from "./CoopMaterialSearchLogic";
import { CoopStretchMenu } from "../../../../component/menu/CoopStretchMenu";

export const CoopViewMaterial: React.FC = (): JSX.Element => {
    ...
    const filterBuyer = () => {
        setSearchBuyer("")
        CoopMaterialSearchLogic(ordersListFilter, status, ordersList, setOrdersList, searchBuyer);
    }

    const clearSearch = () => {
        const clearBuyer = ""
        CoopMaterialSearchLogic(ordersListFilter, status, ordersList, setOrdersList, clearBuyer);
    }
    ...
    return (
        <div>
            ...
            {
                !handleChecked ?
                    <CoopMaterialListSection ordersList={ordersList} parseDate={parseDate} />
                    :
                    <CoopAllMaterialListSection ordersList={ordersList} />
