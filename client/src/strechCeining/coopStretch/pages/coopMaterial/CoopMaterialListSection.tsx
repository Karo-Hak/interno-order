...
import CoopOrderMaterialListSection from './CoopOrderMaterialListSection';

interface CoopMaterialListSectionProps {
    ordersList: any;
    parseDate: any;
}

const CoopMaterialListSection: FC<CoopMaterialListSectionProps> = ({
    ordersList,
    parseDate
}: CoopMaterialListSectionProps) => {
                                ...
                                <tbody>
                                    {ordersList.map((e: any) => (
                                        <React.Fragment key={e._id}>
                                            ...
                                            {showOrderMaterialList[e._id] && <CoopOrderMaterialListSection order={e} parseDate={parseDate} />}
                                        </React.Fragment>
                                    ))}
                                </tbody>
                            </table>
...
export default CoopMaterialListSection;
