...
interface EditCoopBuyerSectionProps {
    register: UseFormRegister<any>;
    setValue: UseFormSetValue<any>;
    orderBuyer: CoopStretchBuyerProps;
    setOrderBuyer: (value: CoopStretchBuyerProps) => void;
  }

const EditCoopBuyerSection: React.FC<EditCoopBuyerSectionProps> = ({ register, setValue, orderBuyer, setOrderBuyer }: EditCoopBuyerSectionProps) => {
...
export default EditCoopBuyerSection;
