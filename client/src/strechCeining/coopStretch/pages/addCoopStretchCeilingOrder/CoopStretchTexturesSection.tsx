...
interface CoopStretchTexturesSectionProps {
    register: UseFormRegister<any>;
    setValue: UseFormSetValue<any>;
    getValues: UseFormGetValues<any>
    stretchRowId: Array<string>
    removeStretchRow: (rowId: string) => void
    stretchTexture: Array<StretchTextureProps>;
}

const CoopStretchTexturesSection: React.FC<CoopStretchTexturesSectionProps> = ({
    register,
    setValue,
    getValues,
    stretchRowId,
    removeStretchRow,
    stretchTexture,
}: CoopStretchTexturesSectionProps) => {
                        ...
                        <tbody>
                            {stretchRowId.map((rowId: any) => (
                                <tr key={rowId}>
                                    ...
                                    <td>
                                        <button type="button" onClick={() => removeStretchRow(rowId)}>
                                            Հեռացնել
                                        </button>
                                    </td>
                                </tr>
...
export default CoopStretchTexturesSection;
