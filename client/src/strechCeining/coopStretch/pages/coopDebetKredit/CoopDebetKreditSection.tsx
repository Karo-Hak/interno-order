...
import BuyerDebetKreditSection from './CoopBuyerDebetKreditSection';
import { useAppDispatch } from '../../../../app/hooks';

interface CoopDebetKreditSectionProps {
    ordersList: any;
    parseDate: any;
}

const CoopDebetKreditSection: FC<CoopDebetKreditSectionProps> = ({
    ordersList,
    parseDate
}: CoopDebetKreditSectionProps) => {
                                ...
                                <tbody>
                                    {ordersList.map((e: any) => (
                                        <React.Fragment key={e._id}>
                                            ...
                                            {showOrderMaterialList[e._id] && <BuyerDebetKreditSection order={e.debetKredit} parseDate={parseDate} />}
                                        </React.Fragment>
                                    ))}
                                </tbody>
                            </table>
...
export default CoopDebetKreditSection;
