...
interface PlintDebetKreditListProps {
    order: any;
    parseDate: any;
}

interface PlintDebetKreditData {
    _id: string;
    date: Date;
    type: string;
    amount: number;
...
const BuyerPlintDebetKreditSection: FC<PlintDebetKreditListProps> = ({
    order,
    parseDate
}: PlintDebetKreditListProps) => {
    ...
    useEffect(() => {
        ...
        order && order.forEach((element: PlintDebetKreditData) => {
                            ...
                            <div>
                                <div >
                                    <table className="tableName">
                                        ...
                                        <tbody>
                                            {order.map((element: PlintDebetKreditData) => (
                                                <tr key={element._id}>
...
export default BuyerPlintDebetKreditSection;
