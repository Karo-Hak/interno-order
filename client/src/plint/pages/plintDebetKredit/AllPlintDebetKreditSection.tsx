...
interface AllPlintDebetKreditSectionProps {
    ordersList: Array<object>;
}

const AllPlintDebetKreditSection: FC<AllPlintDebetKreditSectionProps> = ({
    ordersList,
}: AllPlintDebetKreditSectionProps) => {
...
export default AllPlintDebetKreditSection;
