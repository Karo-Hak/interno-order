...
import { viewPlintDebetKredit } from "../../features/plintDebetKredit/plintDebetKreditApi";
import PlintDebetKreditSection from "./PlintDebetKreditSection";
import { PlintDebetKreditSearchLogic } from "./PlintDebetKreditLogic";
import { PlintMenu } from "../../../component/menu/PlintMenu";

export const ViewPlintDebetKredit: React.FC = (): JSX.Element => {
    ...
    const fetchData = async () => {
        try {
            ...
            const plintOrderResult = await dispatch(viewPlintDebetKredit({ dateFilter, cookies })).unwrap();
    ...
    const filterBuyer = () => {
        setSearchBuyer("")
        PlintDebetKreditSearchLogic(ordersListFilter, orderType, ordersList, setOrdersList, searchBuyer);
    }

    const clearSearch = () => {
        const clearBuyer = ""
        PlintDebetKreditSearchLogic(ordersListFilter, orderType, ordersList, setOrdersList, clearBuyer);
    }
    ...
    return (
        <div>
            ...
            <PlintDebetKreditSection ordersList={ordersList} parseDate={parseDate} />
        </div>
    )
}
