...
import PlintOrderMaterialListSection from './PlintOrderMaterialListSection';

interface PlintMaterialListSectionProps {
    ordersList: any;
    parseDate: any;
}

const PlintMaterialListSection: FC<PlintMaterialListSectionProps> = ({
    ordersList,
    parseDate
}: PlintMaterialListSectionProps) => {
                                ...
                                <tbody>
                                    {ordersList.map((e: any) => (
                                        <React.Fragment key={e._id}>
                                            ...
                                            {showOrderMaterialList[e._id] && <PlintOrderMaterialListSection order={e} parseDate={parseDate} />}
                                        </React.Fragment>
                                    ))}
                                </tbody>
                            </table>
...
export default PlintMaterialListSection;
