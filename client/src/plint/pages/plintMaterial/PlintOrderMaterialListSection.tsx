...
interface PlintOrderMaterialListProps {
    order: any;
    parseDate: any;
}

const PlintOrderMaterialListSection: FC<PlintOrderMaterialListProps> = ({
    order,
    parseDate
}: PlintOrderMaterialListProps) => {
...
export default PlintOrderMaterialListSection;
